...
import com.a4.product.beans.Price;
import com.a4.product.beans.PriceConfiguration;
import com.a4.product.beans.PriceGrid;
import com.a4.product.beans.PriceUnit;
...
public class PriceGridParser {
	...
	public List<PriceGrid> getPriceGrids(String listOfPrices,String listOfQuan,String listOfDisc ,String currency,String priceInclude,
		...
		priceGrid.setIsQUR(isQur == null?ApplicationConstants.CONST_BOOLEAN_FALSE:ApplicationConstants.CONST_BOOLEAN_TRUE);
	...
	public List<PriceGrid> getUpchargePriceGrid(String quantity,String prices ,String discounts, String upChargeCriterias , String qurFlag,String currency
		...
		priceGrid.setIsQUR(qurFlag == null?ApplicationConstants.CONST_BOOLEAN_FALSE: ApplicationConstants.CONST_BOOLEAN_TRUE);
